    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while(input != "quit")
            {
                ...
                //if use chooses hit, cards from the deck are added to the stacks randomly
                ...
                else
                {
                    ...
                    else if (((tableau[moveStop - 1].Count() == 0) && tableau[moveStart - 1][moveCard - 1].cardValue == 13) || ((tableau[moveStart - 1][moveCard - 1].cardSuit == tableau[moveStop - 1][tableau[moveStop - 1].Count - 1].cardSuit) && (tableau[moveStart - 1][moveCard - 1].cardValue < tableau[moveStop - 1][tableau[moveStop - 1].Count - 1].cardValue)))
                    {
                        for (iterator = moveCard - 1; iterator < tableau[moveStart - 1].Count(); iterator++)
                        {
